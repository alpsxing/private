...
openvpn --config /etc/loadshare/client1.conf --local "$ppp_ip0" --script-security 2 --up /etc/loadshare/test/entap0.sh --down /etc/loadshare/test/detap0.sh --up-restart
